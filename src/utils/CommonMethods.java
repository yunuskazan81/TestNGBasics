...
/**
 * Method that will enable to select a file to upload
 * @author yunuskazan
 * @param WebElement elementSendkey, String filePath;
 */

public static void uploadFileSelect(WebElement elementSendKey, String filePath) {
